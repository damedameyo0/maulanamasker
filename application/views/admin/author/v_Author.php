       ...
       <div class="container-fluid">
         ...
         <div class="card mb-4">
           <div class="card-header"><i class="fas fa-table mr-1"></i>List Author
             <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addAuthor"> Add (+) </a>
           </div>
           <div class="card-body">
                 ...
                 <tbody>
                   ...
                   foreach ($author->result_array() as $i) :
                     ...
                     <tr>
                       ...
                       <td>
                         <a type="button" data-bs-toggle="modal" data-bs-target="#editAuthor<?php echo $id; ?>" class="btn btn-primary">Edit</a>
