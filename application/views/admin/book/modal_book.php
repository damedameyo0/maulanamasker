					...
					<div class="modal-body">
						...
						<div class="form-group">
							<div class="row">
								<label for="title" class="col-sm-2 control-label"> Book Description </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="i_description" placeholder="" required>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								<label for="title" class="col-sm-2 control-label"> Book Page </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="i_page" placeholder="" required>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								<label for="title" class="col-sm-2 control-label"> Book Discount </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="i_discount" placeholder="" required>
								</div>
							</div>
						</div>
		...
		<div class="modal-dialog">
			<form class="form" action="<?= base_url('/admin/Book\/delete/' . $id); ?>" method="POST">
				<div class="modal-content">
					...
					<div class="modal-body">
						Pilih "Delete" untuk menghapus Buku dengan title <b><?= $title; ?></b>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
