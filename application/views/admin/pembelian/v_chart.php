                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="post" action="<?php echo base_url('admin/pembelian/chart'); ?>">
                                <div class="row">
                                    ...
                                    <p class="font-weight-lighter"> <em>*The <b> End Date</b> input must be + 1 Day.</em>
                                        <br>e.g. End Date : 01/20/2021 &rarr; <strong> 01/21/2021 </strong>.
                                    </p>
                                </form>
                            </div>
                        </div>
                        <!-- End Search Range Date -->

                        <!-- Start Grafik Garis Pembelian -->
                        <div class="card mb-4">
                            <div class="card-header font-weight-bold"><i class="fas fa-chart-line mr-1"></i> Grafik Garis Pembelian
                            <button class="btn btn-warning" onclick="LinePDF();" style="float: right;">
                                <i class="fas fa-chart-line"></i> Export Chart </button>
                                    ...
                                    <a id="download" download="chart.png">
                                        ...
                                        <div class="card-body"><canvas id="pnjLine" width="80%" height="30"></canvas></div>
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header font-weight-bold"><i class="fas fa-chart-bar"></i> Grafik Batang Pembelian
                                            <button class="btn btn-warning" onclick="BarPDF();" style="float: right;">
                                                ...
                                                <a id="download1" download="chart.jpg">
                                                    ...
                                                    <div class="card-body"><canvas id="pnjBar" width="100%" height="30"></canvas></div>
                                                    <div class="card-footer small text-muted"></div>
                                                </div>
                                                ...
                                                <div class="card mb-4">
                                                    <div class="card-header font-weight-bold"><i class="fas fa-table mr-1"></i> Data Pembelian
                                                    </div>
                                                    <div class="card-body">
